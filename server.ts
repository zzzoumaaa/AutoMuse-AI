  ...
  if (isFlying) {
    return [
      ...
      },
      {
        ...
        value: `${1200 + (seedNum % 500)} kg Thrust`,
...
app.post("/api/generate-concept", async (req, res) => {
  ...
  const MODELS_TO_TRY = ["gemini-2.5-flash", "gemini-3.6-flash", "gemini-2.5-pro"];
